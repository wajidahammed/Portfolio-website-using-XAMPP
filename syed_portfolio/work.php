...
<?php
			...
			$sql = "select CompanyName,Duration,Role,Description from `Professional Experience`";
			...
			{
		$CompanyName[$count] = $row['CompanyName'];
			$Role[$count] = $row['Role'];
		...
		<h1 style="color:rgb(213	221	234	);font-weight:bold;font-size: 400%">WORK EXPERIENCE</h1>
		<p style= "font-family:Rajdhani;">I'm looking to expand my protfolio while I am on top and while I'm young Luis<br> brings your content to life in stunninng clarity</p>
<div class="layout_blog1">
		<div class="blog">
			<p style="color:rgb(27	169	254	);font-weight:bold;font-size: 150%">
			<?php echo $Duration[0]?></br></br></p>
			<p style="color:rgb(213	221	234	);font-weight:bold;"><?php echo $CompanyName[0]?>
			</p>
		</div>
		<div class="blogdetail">
			<p style="font-weight:bold"><?php echo $Role[0]?></br><br></p>
			<p style="font-family:Roboto;color:rgb(87	103	119	);"><?php echo $Description[0]?><br>
			</p>
		</div>
	</div>
	<div class="break1">
	...
	<div class="layout_blog2">
			<div class="blog">
			<p style="color:rgb(27	169	254	);font-weight:bold;font-size: 150%">
			<?php echo $Duration[1]?></br></br></p>
			<p style="color:rgb(213	221	234	);font-weight:bold;"><?php echo $CompanyName[1]?>
			</p>
		</div>
		<div class="blogdetail">
			<p style="font-weight:bold">
			<?php echo $Role[1]?></br><br><br></p>
			<p style="font-family:Roboto;color:rgb(87	103	119	);"><?php echo $Description[1]?>
			</p>
		</div>
	</div>
	<div class="break2">
