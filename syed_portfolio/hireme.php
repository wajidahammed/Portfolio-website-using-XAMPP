  ...
  cursor:pointer;
	...
	<body>
		...
		<?php
			...
			$sql = "select price,title,features from hireme";
		...
		?>
		<h1 style="color:rgb(213	221	234	);font-weight:800;font-size: 400%">HIRE ME</h1>
		...
		<div class="blog">
			<img src="Images/car1.png" style="max-width:90%;max-height:90%;">
		</div>
		<div class="blogdetail">
			<p style="color:rgb(87	103	119	);font-size: 150%"><?php echo $price[0]?></p>
			<p style="color:rgb(87	103	119	);"><?php echo $title[0]?></p>
			<ul style="color:rgb(87	103	119	);">
				<li style= "font-family:Roboto;">Logo</li>
				<li style= "font-family:Roboto;">Advertising image to print</li>
				<li style= "font-family:Roboto;">Photo editing</li>
			</ul>
			<button style="width:175px;height:20px;font-family:Rajdhani;text-align:center;padding:0 "type="button">Contact US</button>			
		</div>
	</div>
	<div class="break1">
		<hr>
	...
	<div class="layout_blog2">
			<div class="blog">
				<img src="Images/car2.png" style="max-width:90%;max-height:90%;">
			</div>
		<div class="blogdetail">
			<p style="color:rgb(87	103	119	);font-size: 150%">$650</p>
			<p style="color:rgb(87	103	119	);">Informative Web Design</p>
			<ul style="color:rgb(87	103	119	);">
				<li style= "font-family:Roboto;">Logo</li>
				<li style= "font-family:Roboto;">Photo Editing</li>
				<li style= "font-family:Roboto;">Site Construction</li>
				<li style= "font-family:Roboto;">Maintaince for 6 months</li>
			</ul>
			<button style="width:175px;height:20px;font-family:Rajdhani;text-align:center;padding:0 "type="button">Contact US</button>
		</div>
	</div>
	...
	<div class="layout_blog3">
		<div class="blog">
			<img src="Images/car3.png" style="max-width:90%;max-height:90%;">

		</div>
		<div class="blogdetail">
			<p style="color:rgb(87	103	119	);font-size: 150%">$1450</p>
			<p style="color:rgb(87	103	119	);">3D Character Design
			</p>
			<ul style="color:rgb(87	103	119	);">
				<li style= "font-family:Roboto;">Character Sketch</li>
				<li style= "font-family:Roboto;">Digitization and Development</li>
				<li style= "font-family:Roboto;">Animation</li>
			</ul>
			<button style="width:175px;height:20px;font-family:Rajdhani;text-align:center;padding:0 "type="button">Contact US</button>
		</div>
	</div>
